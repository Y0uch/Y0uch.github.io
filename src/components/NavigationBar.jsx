            ...
            <nav className="navbar navbar-expand-lg navbar-light">
              <ul className="navbar-nav mx-auto">
                <li className="nav-item">
                  <NavLink to={"/"} className="nav-link" activeClassName="active-link">Designs</NavLink>
                </li>
              <li className="nav-item">
                  <NavLink to={"/illustrations"} className="nav-link" activeClassName="active-link">Illustrations</NavLink>
                </li>
                <li className="nav-item">
